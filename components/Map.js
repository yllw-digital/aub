...
export default function Map() {
    ...
    useEffect(() => {
        loadModules([
            ...
            .then(([esriConfig, WebMap, MapView, Graphic, Locate, GraphicsLayer, Fullscreen, Search, FeatureLayer, watchUtils, WebScene, SceneView, Legend]) => {
                ...
                if(threeD) {
                    const webmap = new WebScene({
                        portalItem: {
                        id: "9115af5509e944678ef12eb222a087f2"
                        }
                    });
                    const view = new SceneView({
                        ...
                        camera: {
                            // 33.894105192767036, 35.493130574235096
                        position: {
                            x: 35.493130574235096, //Longitude
                            y: 33.864105192767036, //Latitude
                            z: 2800 //Meters
                        },
                        tilt: 45
                        }
        ...
        <>
            ...
            {!threeD && <div>
                <div className='filters-and-legend'>
                    <div className={'map-legend ' + (showLegend ? 'opened' : '')}>
                    ...
                    { showLegend && <div className='map-content'>
                        <h3><span>{submissionCount}</span> total submissions.</h3>
                            <h3 className='pb'>Average rent amount by neighborhood (LBP)</h3>
    ...
    {/* //filterButtonContainer */}
            ...
            <div className='threed-btn'>
                <button type='button' className="submitBtn buttonClear" onClick={() => setThreeD(!threeD)}>Toggle 3D Map</button>
            </div>
